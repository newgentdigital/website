  ...
  sv: {
    ...
    footer: {
      ...
      description: {
        ...
        investors:
          "NWG Digital AB är ett svenskt aktiebolag registrerat i Skellefteå. Vi arbetar med kreativa och digitala medietjänster inom design, branding, marknadsföring, kommunikation, webb och innehållsproduktion.",
      },
      visitSocial: "Besök vår sida på",
      ...
      newsletterSignup: {
        ...
        description:
          "Håll dig uppdaterad med de senaste nyheterna och insikterna från Newgent Digital. Nyhetsbrevet skickas ut ungefär en gång i månaden. Du kan avsluta prenumerationen när som helst.",
        formLegend: "Registrera dig för Newgent Pulse-nyhetsbrevet",
        emailLabel: "E-postadress",
        emailPlaceholder: "Din e-postadress",
        submitLabel: "Prenumerera",
        successMessage: "Tack för att du anmälde dig! Vi ses i din inkorg.",
      ...
      links: {
        ...
        resources: {
          ...
          items: {
            blog: "Blogg",
            presskit: "Presskit",
            finconnect: "Finconnect av Newgent",
            quotegenerator: "Offertgenerator",
    ...
    page404: {
      aside:
        "Vi renoverar hemsidan för att kunna ge en bättre upplevelse. Vissa sidor kan vara otillgängliga. Tack för förståelsen!",
      oops: "Oj! Sidan du letar efter finns inte.",
      description:
        "Antingen har sidan du letar efter flyttats eller så finns den inte. Kontrollera länken i adressfältet eller återgå till startsidan.",
      returnHome: "Gå till startsidan",
      believeError:
        "Tror du att detta är ett fel? Vänligen rapportera det till oss.",
    },
    home: {
      newgent: {
        hero: {
      ...
      finconnect: {
        hero: {
          ...
          heading: "Sveriges mest öppna och transparenta finansintegration.",
        },
      },
      investors: {
        hero: {
          label: "Investerarrelationer",
          heading: "Stärker framtiden genom ung kreativ innovation.",
        },
      },
    },
  },
  ...
  en: {
    ...
    footer: {
      ...
      description: {
        ...
        investors:
          "NWG Digital AB is a Swedish limited company (aktiebolag) registered in Skellefteå, Sweden. We operate in creative, digital, and media services, covering design, branding, marketing, communications, web, and content production.",
      },
      visitSocial: "Visit our page on",
      ...
      newsletterSignup: {
        heading: "Sign up for",
        description:
          "Stay updated with the latest news and insights from Newgent Digital. The newsletter is sent out approximately once a month. You can unsubscribe at any time.",
        formLegend: "Register for the Newgent Pulse newsletter",
        emailLabel: "Email address",
        emailPlaceholder: "Your email address",
        submitLabel: "Subscribe",
        successMessage: "Thanks for signing up! See you in your inbox.",
    ...
    page404: {
      aside:
        "We're renovating our website to serve you better. Some pages may be unavailable. Thanks for understanding!",
      oops: "Oops! The route you're looking for doesn't exist.",
      description:
        "Either the page you're looking for has been moved or doesn't exist. Please check the link in your address bar or return to the homepage.",
      returnHome: "Return to homepage",
      believeError: "Do you believe this is an error? Please report it to us.",
    },
    home: {
      newgent: {
        hero: {
      ...
      finconnect: {
        hero: {
          label: "Integrate with Finconnect",
          heading: "Sweden's most open and transparent financial integration.",
        },
      },
      investors: {
        hero: {
          label: "Investor Relations",
          heading: "Empowering the future through young creative innovation.",
        },
      },
    },
  },
