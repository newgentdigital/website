/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 81e0932796ed433cc3ba496131de76c8)
// Runtime types generated with workerd@1.20260120.0 2025-10-21 global_fetch_strictly_public,nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RESEND_API_KEY" | "FORWARDEMAIL_API_KEY" | "LISTMONK_BASE_URL" | "LISTMONK_API_USER" | "LISTMONK_API_TOKEN" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "SENTRY_AUTH_TOKEN">> {}
}
...
declare class DOMException extends Error {
  ...
  /**
   * The **`message`** read-only property of the a message or description
  ...
  /**
   * The **`name`** read-only property of the one of the strings associated with
   * an error name.
   *
   * [MDN
  ...
  /**
   * The **`code`** read-only property of the DOMException interface returns one
   * of the legacy error code constants, or `0` if none match.
   *
   * @deprecated
   *
   *   [MDN
...
interface Console {
  ...
  clear(): void;
  /**
   * The **`console.count()`** static method logs the number of times that this
   * particular call to `count()` has been called.
   *
   * [MDN
  ...
  /**
   * The **`console.countReset()`** static method resets counter used with
   * console/count_static.
   *
   * [MDN
  ...
  /**
   * The **`console.debug()`** static method outputs a message to the console at
   * the 'debug' log level.
   *
   * [MDN
  ...
  debug(...data: any[]): void;
  /**
   * The **`console.dir()`** static method displays a list of the properties of
  ...
  /**
   * The **`console.dirxml()`** static method displays an interactive tree of
   * the descendant elements of the specified XML/HTML element.
   *
   * [MDN
  ...
  /**
   * The **`console.error()`** static method outputs a message to the console at
   * the 'error' log level.
   *
   * [MDN
  ...
  error(...data: any[]): void;
  /**
   * The **`console.group()`** static method creates a new inline group in the
   * Web console log, causing any subsequent console messages to be indented by
   * an additional level, until console/groupEnd_static is called.
   *
   * [MDN
  ...
  group(...data: any[]): void;
  /**
   * The **`console.groupCollapsed()`** static method creates a new inline group
   * in the console.
   *
   * [MDN
  ...
  /**
   * The **`console.groupEnd()`** static method exits the current inline group
   * in the console.
   *
   * [MDN
  ...
  groupEnd(): void;
  /**
   * The **`console.info()`** static method outputs a message to the console at
   * the 'info' log level.
   *
   * [MDN
  ...
  /**
   * The **`console.time()`** static method starts a timer you can use to track
  ...
  /**
   * The **`console.timeEnd()`** static method stops a timer that was previously
  ...
  /**
   * The **`console.timeLog()`** static method logs the current value of a timer
   * that was previously started by calling console/time_static.
   *
   * [MDN
  ...
  /**
   * The **`console.trace()`** static method outputs a stack trace to the
   * console.
   *
   * [MDN
  ...
  trace(...data: any[]): void;
  /**
   * The **`console.warn()`** static method outputs a warning message to the
   * console at the 'warning' log level.
   *
   * [MDN
...
/**
 * The **`ServiceWorkerGlobalScope`** interface of the Service Worker API
 * represents the global execution context of a service worker. Available only
 * in secure contexts.
 *
 * [MDN
...
declare class Event {
  ...
  /**
   * The read-only **`composed`** property of the or not the event will
   ...
   * whether the event can be canceled, and therefore prevented as if the event
   * never happened.
   *
   * [MDN
  ...
  /**
   * The Event property **`returnValue`** indicates whether the default action
  ...
  /**
   * The **`timeStamp`** read-only property of the Event interface returns the
  ...
  /**
   * The **`isTrusted`** read-only property of the when the event was generated
   * by the user agent (including via user actions and programmatic methods such
   * as HTMLElement.focus()), and `false` when the event was dispatched via The
   * only exception is the `click` event, which initializes the `isTrusted`
  ...
  /**
   * The **`stopImmediatePropagation()`** method of the If several listeners are
   * attached to the same element for the same event type, they are called in
   ...
   * agent that if the event does not get explicitly handled, its default action
...
> {
   ...
   * function that will be called whenever the specified event is delivered to
   * the target.
   *
   * [MDN
  ...
  /**
   * The **`removeEventListener()`** method of the EventTarget interface removes
...
declare abstract class AbortSignal extends EventTarget {
   ...
   * already set as aborted (and which does not trigger an
  ...
  /**
   * The **`AbortSignal.timeout()`** static method returns an AbortSignal that
   * will automatically abort after a specified time.
   *
   * [MDN
   ...
   * signals and returns an AbortSignal.
   *
   * [MDN
...
declare class Blob {
  ...
  /**
   * The **`size`** read-only property of the Blob interface returns the size of
   * the Blob or File in bytes.
   *
   ...
   * `Blob` object which contains data from a subset of the blob on which it's
   * called.
   *
   ...
   * resolves with a Uint8Array containing the contents of the blob as an array
   * of bytes.
   *
  ...
  /**
   * The **`text()`** method of the string containing the contents of the blob,
  ...
  text(): Promise<string>;
  /**
   * The **`stream()`** method of the Blob interface returns a ReadableStream
...
declare class File extends Blob {
  ...
  /**
   * The **`name`** read-only property of the File interface returns the name of
   ...
   * the last modified date of the file as the number of milliseconds since the
...
declare abstract class Crypto {
  /**
   * The **`Crypto.subtle`** read-only property returns a cryptographic
   * operations. Available only in secure contexts.
   *
   ...
   * v4 UUID using a cryptographically secure random number generator. Available
 ...
 * low-level cryptographic functions. Available only in secure contexts.
 *
...
declare abstract class SubtleCrypto {
   ...
   * _digest_ of the given data, using the specified hash function.
   *
   * [MDN
  ...
  /**
   * The **`deriveKey()`** method of the SubtleCrypto interface can be used to
   ...
   * that is, it takes as input a key in an external, portable format and gives
  ...
  /**
   * The **`exportKey()`** method of the SubtleCrypto interface exports a key:
   * that is, it takes as input a CryptoKey object and gives you the key in an
...
/**
 * The **`CryptoKey`** interface of the Web Crypto API represents a
 * cryptographic key obtained from one of the SubtleCrypto methods
 * SubtleCrypto.generateKey, SubtleCrypto.deriveKey, SubtleCrypto.importKey, or
 * SubtleCrypto.unwrapKey. Available only in secure contexts.
 *
...
declare abstract class CryptoKey {
   ...
   * which kind of key is represented by the object.
   *
  ...
  /**
   * The read-only **`algorithm`** property of the CryptoKey interface returns
   * an object describing the algorithm for which this key can be used, and any
   * associated extra parameters.
   *
   * [MDN
 ...
 * encoding, such as `UTF-8`, `ISO-8859-2`, `KOI8-R`, `GBK`, etc.
 *
...
declare class TextEncoder {
   ...
   * a Global_Objects/Uint8Array containing the text given in parameters encoded
  ...
  /**
   * The **`TextEncoder.encodeInto()`** method takes a string to encode and a
   * destination Uint8Array to put resulting UTF-8 encoded text into, and
   * returns a dictionary object indicating the progress of the encoding.
   *
   * [MDN
...
declare class ErrorEvent extends Event {
  ...
  /**
   * The **`filename`** read-only property of the ErrorEvent interface returns a
  ...
  get filename(): string;
  /**
   * The **`message`** read-only property of the ErrorEvent interface returns a
  ...
  get message(): string;
  /**
   * The **`lineno`** read-only property of the ErrorEvent interface returns an
   * integer containing the line number of the script file on which the error
   * occurred.
   *
   * [MDN
  ...
  get lineno(): number;
  /**
   * The **`colno`** read-only property of the ErrorEvent interface returns an
   * integer containing the column number of the script file on which the error
   * occurred.
   *
   * [MDN
   ...
   * JavaScript value, such as an Error or DOMException, representing the error
...
declare class MessageEvent extends Event {
  ...
  /**
   * The **`data`** read-only property of the The data sent by the message
   * emitter; this can be any data type, depending on what originated this
   * event.
   *
   * [MDN
  ...
  /**
   * The **`ports`** read-only property of the containing all MessagePort
...
/**
 * The **`PromiseRejectionEvent`** interface represents events which are sent to
 * the global script context when JavaScript Promises are rejected.
 *
 * [MDN
...
declare abstract class PromiseRejectionEvent extends Event {
  /**
   * The PromiseRejectionEvent interface's **`promise`** read-only property
   * indicates the JavaScript rejected.
   *
   * [MDN
  ...
  /**
   * The PromiseRejectionEvent **`reason`** read-only property is any JavaScript
   * value or Object which provides the reason passed into Promise.reject().
   *
   * [MDN
 ...
 * Window/fetch, XMLHttpRequest.send() or navigator.sendBeacon() methods.
 *
...
declare class FormData {
   ...
   * onto an existing key inside a `FormData` object, or adds the key if it does
   * not already exist.
   *
   ...
   * associated with a given key from within a `FormData` object.
   *
   * [MDN Reference](https://developer.mozilla.org/docs/Web/API/FormData/get)
   */
  get(name: string): (File | string) | null;
  /**
   * The **`getAll()`** method of the FormData interface returns all the values
   * associated with a given key from within a `FormData` object.
   *
...
declare abstract class FetchEvent extends ExtendableEvent {
  ...
  /**
   * The **`respondWith()`** method of allows you to provide a promise for a
   * Response yourself.
   *
   * [MDN
...
declare class Headers {
  ...
  /**
   * The **`get()`** method of the Headers interface returns a byte string of
   * all the values of a header within a `Headers` object with a given name.
   *
  ...
  /**
   * The **`getSetCookie()`** method of the Headers interface returns an array
   * containing the values of all Set-Cookie headers associated with a
   * response.
   *
   * [MDN
  ...
  set(name: string, value: string): void;
  /**
   * The **`append()`** method of the Headers interface appends a new value onto
   * an existing header inside a `Headers` object, or adds the header if it does
   * not already exist.
   *
  ...
  append(name: string, value: string): void;
  /**
   * The **`delete()`** method of the Headers interface deletes a header from
   * the current `Headers` object.
   *
...
interface Response extends Body {
  ...
  clone(): Response;
  /**
   * The **`status`** read-only property of the Response interface contains the
  ...
  status: number;
  /**
   * The **`statusText`** read-only property of the Response interface contains
   * the status message corresponding to the HTTP status code in
   * Response.status.
   *
   * [MDN
  ...
  ok: boolean;
  /**
   * The **`redirected`** read-only property of the Response interface indicates
   * whether or not the response is the result of a request you made which was
   * redirected.
   *
   * [MDN
...
> extends Body {
  ...
  /**
   * The **`method`** read-only property of the `POST`, etc.) A String
  ...
  method: string;
  /**
   * The **`url`** read-only property of the Request interface contains the URL
   * of the request.
   *
  ...
  headers: Headers;
  /**
   * The **`redirect`** read-only property of the Request interface contains the
   ...
   * whether the browser will keep the associated request alive if the page that
   * initiated it is unloaded before the request is complete.
   *
   * [MDN
...
interface ReadableStream<R = any> {
  /**
   * The **`locked`** read-only property of the ReadableStream interface returns
  ...
  get locked(): boolean;
  /**
   * The **`cancel()`** method of the ReadableStream interface returns a Promise
   ...
   * chainable way of piping the current stream through a transform stream or
   ...
   * `ReadableStream` to a given WritableStream and returns a Promise that
   * fulfills when the piping process completes successfully, or rejects if any
   * errors were encountered.
   *
   * [MDN
  ...
  /**
   * The **`tee()`** method of the two-element array containing the two
...
declare class ReadableStreamDefaultReader<R = any> {
  ...
  /**
   * The **`releaseLock()`** method of the ReadableStreamDefaultReader interface
 ...
 * for a ReadableStream that supports zero-copy reading from an underlying byte
 * source.
 *
 * [MDN
...
declare class ReadableStreamBYOBReader {
  ...
  cancel(reason?: any): Promise<void>;
  /**
   * The **`read()`** method of the ReadableStreamBYOBReader interface is used
   * to read data into a view on a user-supplied buffer from an associated
 ...
 * 'pull request' for data from an underlying source that will made as a
 * zero-copy transfer to a consumer (bypassing the stream's internal queues).
 *
 * [MDN
...
declare abstract class ReadableStreamBYOBRequest {
  /**
   * The **`view`** getter property of the ReadableStreamBYOBRequest interface
   ...
   * used to signal to the associated readable byte stream that the specified
   * number of bytes were written into the ReadableStreamBYOBRequest.view.
   *
   * [MDN
   ...
   * interface specifies a new view that the consumer of the associated readable
   * byte stream should write to instead of ReadableStreamBYOBRequest.view.
   *
   * [MDN
...
declare abstract class ReadableStreamDefaultController<R = any> {
  /**
   * The **`desiredSize`** read-only property of the required to fill the
  ...
  /**
   * The **`close()`** method of the ReadableStreamDefaultController interface
  ...
  close(): void;
  /**
   * The **`enqueue()`** method of the `js-nolint enqueue(chunk) ` - `chunk` - :
 ...
 * represents a controller for a readable byte stream.
 *
 * [MDN
...
declare abstract class ReadableByteStreamController {
   ...
   * ReadableByteStreamController interface returns the current BYOB request, or
   ...
   * ReadableByteStreamController interface returns the number of bytes required
   * to fill the stream's internal queue to its 'desired size'.
   *
   * [MDN
   ...
   * enqueues a given chunk on the associated readable byte stream (the chunk is
   * copied into the stream's internal queues).
   *
   * [MDN
   ...
   * causes any future interactions with the associated stream to error with the
   * specified reason.
   *
   * [MDN
...
/**
 * The **`WritableStreamDefaultController`** interface of the Streams API
 * represents a controller allowing control of a WritableStream's state.
 *
 * [MDN
...
declare abstract class WritableStreamDefaultController {
  /**
   * The read-only **`signal`** property of the WritableStreamDefaultController
   * interface returns the AbortSignal associated with the controller.
   *
   * [MDN
...
declare abstract class TransformStreamDefaultController<O = any> {
  /**
   * The **`desiredSize`** read-only property of the
   * TransformStreamDefaultController interface returns the desired size to fill
   * the queue of the associated ReadableStream.
   *
   * [MDN
  ...
  /**
   * The **`error()`** method of the TransformStreamDefaultController interface
 ...
 * abstraction for writing streaming data to a destination, known as a sink.
 *
...
declare class WritableStream<W = any> {
  ...
  /**
   * The **`locked`** read-only property of the WritableStream interface returns
   ...
   * and it is to be immediately moved to an error state, with any queued writes
   * discarded.
   *
   * [MDN
  ...
  close(): Promise<void>;
  /**
   * The **`getWriter()`** method of the WritableStream interface returns a new
...
/**
 * The **`WritableStreamDefaultWriter`** interface of the Streams API is the
 * object returned by WritableStream.getWriter() and once created locks the
 * writer to the `WritableStream` ensuring that no other streams can write to
 * the underlying sink.
 *
 * [MDN
...
declare class WritableStreamDefaultWriter<W = any> {
  ...
  /**
   * The **`closed`** read-only property of the the stream errors or the
  ...
  get closed(): Promise<void>;
  /**
   * The **`ready`** read-only property of the that resolves when the desired
   * size of the stream's internal queue transitions from non-positive to
  ...
  /**
   * The **`desiredSize`** read-only property of the to fill the stream's
   * internal queue.
   *
   * [MDN
  ...
  get desiredSize(): number | null;
  /**
   * The **`abort()`** method of the the producer can no longer successfully
   * write to the stream and it is to be immediately moved to an error state,
...
/**
 * The **`TransformStream`** interface of the Streams API represents a concrete
 * implementation of the pipe chain _transform stream_ concept.
 *
...
declare class TransformStream<I = any, O = any> {
   ...
   * returns the ReadableStream instance controlled by this `TransformStream`.
   *
   * [MDN
   ...
   * returns the WritableStream instance controlled by this `TransformStream`.
   *
   * [MDN
...
/**
 * The **`DecompressionStream`** interface of the Compression Streams API is an
 * API for decompressing a stream of data.
 *
 * [MDN
...
/**
 * The **`TextEncoderStream`** interface of the Encoding API converts a stream
 * of strings into bytes in the UTF-8 encoding.
 *
...
/**
 * The **`TextDecoderStream`** interface of the Encoding API converts a stream
 * of text in a binary encoding, such as UTF-8 etc., to a stream of strings.
 *
...
/**
 * The **`ByteLengthQueuingStrategy`** interface of the Streams API provides a
...
/**
 * The **`CountQueuingStrategy`** interface of the Streams API provides a
 * built-in chunk counting queuing strategy that can be used when constructing
 * streams.
 *
 * [MDN
...
declare class CountQueuingStrategy implements QueuingStrategy {
  constructor(init: QueuingStrategyInit);
  /**
   * The read-only **`CountQueuingStrategy.highWaterMark`** property returns the
   * total number of chunks that can be contained in the internal queue before
...
declare class URL {
  ...
  /**
   * The **`origin`** read-only property of the URL interface returns a string
  ...
  get origin(): string;
  /**
   * The **`href`** property of the URL interface is a string containing the
   * whole URL.
   *
  ...
  /**
   * The **`protocol`** property of the URL interface is a string containing the
   * protocol or scheme of the URL, including the final `':'`.
   *
  ...
  /**
   * The **`username`** property of the URL interface is a string containing the
   * username component of the URL.
   *
  ...
  /**
   * The **`password`** property of the URL interface is a string containing the
   * password component of the URL.
   *
   ...
   * host, which is the URL.hostname, and then, if the port of the URL is
   * nonempty, a `':'`, followed by the URL.port of the URL.
   *
   ...
   * either the domain name or IP address of the URL.
   *
  ...
  /**
   * The **`pathname`** property of the URL interface represents a location in a
  ...
  /**
   * The **`searchParams`** read-only property of the access to the [MISSING:
   * httpmethod('GET')] decoded query arguments contained in the URL.
   *
   * [MDN
  ...
  /**
   * The **`toJSON()`** method of the URL interface returns a string containing
   * a serialized version of the URL, although in practice it seems to have the
   * same effect as `js-nolint toJSON() ` None.
   *
  ...
  /**
   * The **`createObjectURL()`** static method of the URL interface creates a
  ...
  /**
   * The **`revokeObjectURL()`** static method of the URL interface releases an
   * existing object URL which was previously created by calling Call this
   * method when you've finished using an object URL to let the browser know not
...
declare class URLSearchParams {
  ...
  get(name: string): string | null;
  /**
   * The **`getAll()`** method of the URLSearchParams interface returns all the
   * values associated with a given search parameter as an array.
   *
   * [MDN
   ...
   * value that indicates whether the specified parameter is in the search
   * parameters.
   *
   * [MDN
   ...
   * associated with a given search parameter to the given value.
   *
   * [MDN
   ...
   * in this object in place and returns `undefined`.
   *
   * [MDN
...
declare class CloseEvent extends Event {
   ...
   * WebSocket connection close code indicating the reason the connection was
   * closed.
   *
  ...
  readonly code: number;
  /**
   * The **`reason`** read-only property of the CloseEvent interface returns the
   * WebSocket connection close reason the server gave for closing the
   * connection; that is, a concise human-readable prose explanation for the
   * closure.
   *
   * [MDN
...
interface WebSocket extends EventTarget<WebSocketEventMap> {
   ...
   * transmitted to the server over the WebSocket connection, increasing the
   * value of `bufferedAmount` by the number of bytes needed to contain the
   * data.
   *
  ...
  /**
   * The **`WebSocket.close()`** method closes the already `CLOSED`, this method
   * does nothing.
   *
  ...
  /**
   * The **`WebSocket.readyState`** read-only property returns the current state
  ...
  readyState: number;
  /**
   * The **`WebSocket.url`** read-only property returns the absolute URL of the
   * WebSocket as resolved by the constructor.
   *
   ...
   * sub-protocol the server selected; this will be one of the strings specified
   * in the `protocols` parameter when creating the WebSocket object, or the
...
declare class EventSource extends EventTarget {
  ...
  /**
   * The **`close()`** method of the EventSource interface closes the
   * connection, if one is made, and sets the `js-nolint close() ` None.
   *
   * [MDN
  ...
  get url(): string;
  /**
   * The **`withCredentials`** read-only property of the the `EventSource`
...
/**
 * The **`MessagePort`** interface of the Channel Messaging API represents one
 * of the two ports of a MessageChannel, allowing messages to be sent from one
 * port and listening out for them arriving at the other.
 *
 * [MDN Reference](https://developer.mozilla.org/docs/Web/API/MessagePort)
 */
declare abstract class MessagePort extends EventTarget {
  /**
   * The **`postMessage()`** method of the transfers ownership of objects to
  ...
  /**
   * The **`close()`** method of the MessagePort interface disconnects the port,
  ...
  close(): void;
  /**
   * The **`start()`** method of the MessagePort interface starts the sending of
   * messages queued on the port.
   *
   * [MDN
...
declare class MessageChannel {
  constructor();
  /**
   * The **`port1`** read-only property of the the port attached to the context
   * that originated the channel.
   *
   * [MDN
  ...
  /**
   * The **`port2`** read-only property of the the port attached to the context
   * at the other end of the channel, which the message is initially sent to.
   *
   * [MDN
 ...
 *
 * It's a stripped down version from its source. It currently supports basic
 * function calling, json mode and accepts images as input.
 *
 * It does not include types for WebSearch, CodeInterpreter, FileInputs, MCP,
 * CustomTools. We plan to add those incrementally as model + platform
 * capabilities evolve.
 */
type ResponsesInput = {
...
interface Ai_Cf_Deepgram_Flux_Input {
  ...
  sample_rate: string;
  /**
   * End-of-turn confidence required to fire an eager end-of-turn event. When
   * set, enables EagerEndOfTurn and TurnResumed events. Valid Values 0.3 -
   * 0.9.
   */
  ...
  /**
   * Keyterm prompting can improve recognition of specialized terminology. Pass
   * multiple keyterm query parameters to boost multiple keyterms.
   */
  keyterm?: string;
  /**
   * Opts out requests from the Deepgram Model Improvement Program. Refer to
   * Deepgram Docs for pricing impacts before setting this to true.
   * https://dpgr.am/deepgram-mip
   */
...
type AiOptions = {
   ...
   *
   * Rules: Tags must only contain letters, numbers, and the symbols: : - . / @
   * Each tag can have maximum 50 characters. Maximum 5 tags are allowed each
   * request. Duplicate tags will removed.
   */
  tags?: string[];
...
declare module "cloudflare:pipelines" {
  ...
  > {
    ...
    /**
     * Run receives an array of PipelineRecord which can be transformed and
